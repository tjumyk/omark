...
class MyFlask(Flask):
    ...
    _hashed_static_file_pattern_alt = re.compile(r'^[a-z0-9]{20}\..+\.\w+$')
    ...
    def send_region_static_file(self, filename, region):
        ...
        elif self._hashed_static_file_pattern.fullmatch(filename) or \
                self._hashed_static_file_pattern_alt.fullmatch(filename):
